...
function Position.new(board, turn, castling_rights, passant_target)
    local s = {
        board = board,
        turn = turn,
    ...
    return setmetatable(s, { __index = Position })
end

function Position.CastlingRights(white_kingside, white_queenside, black_kingside, black_queensize)
    return {
        white = {
